...
public class Solemne1 {
    ...
    public static void main(String[] args) {
        ...
        Empleados[0] = new ResponsableNomina("13467567k", "Emilio", "Silva", 01, 02, 1993, "Universitario");
        Empleados[1] = new Contador("13467567k", "Emilio", "Silva", 01, 02, 1993, "Universitario");
        ...
        Empleados[13] = new Asistente("18392821k", "agustin", "rodriguez", 01, 02, 1993, "Universitario");
        Empleados[14] = new Asistente("123456789", "asistente", "segundo", 02, 02, 2002, "Universitario");
